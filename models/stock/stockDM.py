...
class StockKline(Model):
    ...
    stock_code = CharField(max_length=24, null=False, verbose_name="股票编号")
    stock_name = CharField(max_length=24, null=False, verbose_name="股票名称")
